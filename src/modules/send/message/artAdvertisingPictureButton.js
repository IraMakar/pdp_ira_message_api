...
const texts = {
  ...
  ru: {
    title: "Оплата за рекламу картины",
    description: 'Оплата за рекламу выбранной вами картины👆:',
    label: "Реклама картины",
    button_1: "Оплатить",
    button_2: "Назад",
    button_3: "В меню",
  },
  en: {
    title: "Payment for advertising the picture",
    description: 'Payment for advertising the picture you have chosen👆:',
    label: "Advertising paintings",
    button_1: "Pay",
    button_2: "Back",
    button_3: "To menu",
  },
